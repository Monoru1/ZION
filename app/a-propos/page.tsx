...
export const metadata = { title: "Notre histoire — ZION", description: "Pourquoi ZION existe et ce que l’archive choisit de transmettre." };

export default function AboutPage() {
  return <main className="archive-page about-page"><SiteHeader current="/a-propos" />
    <section className="about-hero"><ArchiveEyebrow>NOTRE HISTOIRE / DOSSIER OUVERT</ArchiveEyebrow><h1>UNE MARQUE<br />NE SUFFIT<br /><em>PAS.</em></h1><p>ZION est un projet culturel qui choisit le vêtement comme support, l’archive comme méthode et la transmission comme horizon.</p></section>
